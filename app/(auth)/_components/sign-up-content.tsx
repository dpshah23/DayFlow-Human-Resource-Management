    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <Card className="w-full max-w-md p-6 space-y-4 shadow-md rounded-2xl">
        <CardHeader className="space-y-2">
          <Skeleton className="h-8 rounded-lg w-36" /> {/* Title */}
          <Skeleton className="h-4 rounded-md w-44" /> {/* Subtitle */}
        </CardHeader>

        <CardBody className="space-y-3">
          {/* Mimic the input fields */}
          <Skeleton className="w-full h-10 rounded-md" /> {/* Name */}
          <Skeleton className="w-full h-10 rounded-md" /> {/* Phone */}
          <Skeleton className="w-full h-10 rounded-md" /> {/* Email */}
          <Skeleton className="w-full h-10 rounded-md" /> {/* Password */}
